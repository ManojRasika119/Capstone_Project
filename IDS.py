...
class IDS:
	...
	def svm_with_third_party(self) :
		...
		svm_predict = svm_object.predict(self.test_data_scaled_normalized)  # type: Any
		assert isinstance(svm_predict, object)
		print svm_predict_score(self.test_data_scaled_normalized, self.test_target_decoded)
